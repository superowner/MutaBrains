...
namespace MutaBrains.Core.Physics
{
    struct NarrowPhaseCallback : INarrowPhaseCallbacks
    {
    ...
    struct PoseIntegratorCallback : IPoseIntegratorCallbacks
    {
        ...
        public PoseIntegratorCallback(Vector3 gravity, float linearDamping = .03f, float angularDamping = .03f) : this()
        {
            Gravity = gravity;
