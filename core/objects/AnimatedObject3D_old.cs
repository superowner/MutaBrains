...
namespace MutaBrains.Core.Objects
{
    ...
    class AnimatedObject3DOLD : Object3D
    {
        ...
        //         GL.DrawArrays(OpenTK.Graphics.OpenGL4.PrimitiveType.Triangles, 0, all_vertices.Count);
        ...
        //             vertex1.Position = GLConverter.FromVector3(vertex_1);
        //             vertex1.Normal = GLConverter.FromVector3(normal_1);
        ...
        //             vertex2.Position = GLConverter.FromVector3(vertex_2);
        //             vertex2.Normal = GLConverter.FromVector3(normal_2);
        ...
        //             vertex3.Position = GLConverter.FromVector3(vertex_3);
        //             vertex3.Normal = GLConverter.FromVector3(normal_3);
        ...
        //     }
        // }
        public AnimatedObject3DOLD(string name, string path, Vector3 position, Vector3 scale) : base(name, path, position, scale)
        {
        }
    }
}
